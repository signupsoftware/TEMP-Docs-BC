...
|**Send reminders for on hold documents**	|12057077	|Ex Email NAS <br/> <br/>This job queue will send reminders for on hold documents <br/><br/> Use this Parameter String in the Job Queue Entry Card: ON HOLD REMINDER <br/> 	|Yes
|**Send reminders for the approved quote/order to the creator of these documents**	|(12057077)	|(Ex Email NAS) <br/><br/> Send reminders for approved quote/orders to the creator of the quote/orders. No Job needs to be setup in Job Queue Entry. <br/><br/> PQ/PO Creator Email needs to be entered under in ExFlow Email Setup --> General <br/><br/> The setting ''Send Email For Approved Order/Quote'' must be enabled in ExFlow Setup --> Order and Quote Approval --> Send Email For Approved Order/Quote	|Yes
...
|**Coding Suggestion**	|12013594	|Update Coding Set ID on Documents - Project <br/><br/> Then Report 12013593 (ExFlow Coding Suggestion Setup - Update – Project) can be used. Recommend once per day, after office time |No
