...
|**Editar Columnas Web**	|Realizar cambios en las columnas web actuales de ExFlow. <br/> <br/>Lea más sobre esto en la sección [**ExFlow Web**](https://docs.signupsoftware.com/business-central/docs/user-manual/technical/exflow-web#exflow-web) <br/>
...
|**Configuración de Omitir Verificación de Cambios**| Abre la ventana de configuración para omitir la verificación de cambios. <br/><br/> Lea más sobre esto en la sección [***Omitir Verificación de Cambios***](https://docs.signupsoftware.com/business-central/docs/user-manual/business-functionality/bypass-verify-changes)
