...
|**Relacionado --> Configuración de ExFlow**	|Abre [***Configuración de ExFlow***](https://docs.exflow.cloud/business-central/docs/user-manual/technical/exflow-setup)
|**Relacionado --> Registro de Auditoría --> Registro de Auditoría**	|Abre la Vista General del Registro de Auditoría. <br/><br/> Lea más sobre esto en la sección [***Registro de Auditoría***](https://docs.exflow.cloud/business-central/docs/user-manual/business-functionality/audit-log#audit-log)
