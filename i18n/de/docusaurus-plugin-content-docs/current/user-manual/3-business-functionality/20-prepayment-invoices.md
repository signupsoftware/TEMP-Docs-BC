...
![ExFlow Web - Vorauszahlungsnachricht](@site/static/img/media/web-chat-001.png)
...
![ExFlow Web - Vorauszahlung](@site/static/img/media/web-purchase-invoice-001.png)

Wenn der Benutzer versucht, die Kodierung zu ändern, erscheint beim Genehmigen folgende Fehlermeldung:

![ExFlow Web - Vorauszahlungsfehlermeldung](@site/static/img/media/web-dynamics-error-001.png)
...
![Bestellauftrag - Vorauszahlung](@site/static/img/media/purchase-order-003.png)

Die Vorauszahlungsrechnung und der Genehmigungsverlauf können auch im Genehmigungsstatusverlauf nachverfolgt werden.

![ExFlow Genehmigungsstatusverlauf - Vorauszahlung](@site/static/img/media/approval-status-history-001.png)
...
![ExFlow Importjournal - Vorauszahlung](@site/static/img/media/import-journal-030.png)

Informationen zu reduzierten Vorauszahlungen sind im Fact Box auf der rechten Seite unter Dokumentdetails zu sehen.

![ExFlow Importjournal - Dokumentdetails für Vorauszahlung](@site/static/img/media/import-journal-031-document-details.png)
...
![ExFlow Importjournal - Warnmeldung für teilweise übereinstimmende 100% Vorauszahlungsbestellungen](@site/static/img/media/warning-messages-003.png)
...
![Diskussionspanel - Vorauszahlung](@site/static/img/media/discussion-panel-002.png)
...
![ExFlow Genehmigungsstatus - Vorauszahlung](@site/static/img/media/approval-status-006.png)

### Endgültige Vorauszahlungsrechnung in ExFlow Web

Im Chat kann der Genehmigende folgende Nachricht sehen:

![ExFlow Web - Vorauszahlungsnachricht](@site/static/img/media/web-chat-002.png)

Der Genehmigende muss immer noch den vollen Bestellbetrag genehmigen. Die Reduzierung erfolgt beim Buchen der Bestellung.

![ExFlow Web - Vorauszahlung](@site/static/img/media/web-purchase-invoice-002.png)
...
![ExFlow Genehmigungsstatusverlauf - Vorauszahlung](@site/static/img/media/approval-status-history-002.png)

Und die Diskussionsnachricht enthält immer noch die automatisch erstellte Nachricht:

![Diskussionspanel - Vorauszahlung](@site/static/img/media/discussion-panel-003.png)

Um die Reduzierung für früher gebuchte Vorauszahlungen zu sehen, gehen Sie zur Karte.

![Gebuchte Einkaufsrechnung - Vorauszahlung](@site/static/img/media/purchase-invoice-004.png)
