...
![Vertrauliche Dokumente](@site/static/img/media/exflow-setup-confidential-documents-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/exflow-setup-confidential-documents-002.png)
...
![Vertrauliche Dokumente](@site/static/img/media/exflow-user-confidential-access-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/exflow-user-confidential-access-002.png)
...
![Vertrauliche Dokumente](@site/static/img/media/exflow-user-confidential-access-003.png)

Der untenstehende ExFlow-Benutzer hat nun Zugriff auf alle vertraulichen Dokumente im Unternehmen SignUp.

![Vertrauliche Dokumente](@site/static/img/media/exflow-user-confidential-access-004.png)
...
![Vertrauliche Dokumente](@site/static/img/media/approval-rule-confidential-approval-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-002.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-003.png)
...
![Vertrauliche Dokumente](@site/static/img/media/vendor-setup-confidential-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/confidential-documents-approval-status-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-004.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-005.png)
...
![Vertrauliche Dokumente](@site/static/img/media/import-journal-confidential-006.png)
...
![Vertrauliche Dokumente](@site/static/img/media/confidential-documents-web-001.png)
...
![Vertrauliche Dokumente](@site/static/img/media/confidential-documents-web-002.png)
...
![Vertrauliche Dokumente](@site/static/img/media/confidential-documents-web-003.png)
