...
|**Verwandt --> ExFlow Setup** |Öffnet [***ExFlow Setup***](https://docs.exflow.cloud/business-central/docs/user-manual/technical/exflow-setup)
...
Die Option „Von ExFlow Setup“ ist standardmäßig in den meisten Einstellungen gesetzt, was bedeutet, dass ExFlow die Standardkonfiguration (aus [***ExFlow Setup***](https://docs.exflow.cloud/business-central/docs/user-manual/technical/exflow-setup#exflow-setup)) übernimmt, wenn keine andere Konfiguration auf der Lieferanteneinrichtungskarte für den spezifischen Lieferanten ausgewählt ist.
