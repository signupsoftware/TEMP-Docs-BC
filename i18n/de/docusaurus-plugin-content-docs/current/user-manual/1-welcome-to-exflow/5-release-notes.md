...
| :----------- | :-------------- | :-------------- |
|24166, 46179 |Neue Bestellabstimmung |Völlig neue und erweiterte Bestellabstimmungsfunktionalität zusammen mit einem speziellen Arbeitsbereich für Einkäufer.|
|43932, 45416 |Lizenzanbieter und Funktionsverwaltung |Ein neuer Lizenzanbieter zur Unterstützung zukünftiger Lizenzmodelle zusammen mit Funktionsverwaltung für eine genauere Steuerung, welche Funktionen in verschiedenen Szenarien aktiviert sind.|
|39209 |Neue Bestellabstimmung |Eine neue, assistentengesteuerte Erfahrung zur Einrichtung von ExFlow AP, die viele manuelle Aufgaben in früheren Versionen ersetzt.|
|44723 |Einrichtung |Verbesserte Funktionalität und Nachverfolgung der ExFlow-E-Mail-Protokolle.|
|34279 |Finnische Lokalisierung |Verbesserung der FI-Lokalisierung: Finnische Referenznummer für Selbstrechnungen.|
|43229 |Genehmigungsstatus |Standardmäßige Zahlungsadresse auf Lieferantenkarte – wird auf ExFlow-Rechnungen nicht angezeigt.|
|44384 |Web |Aktivieren von Codierungsänderungen für vertrauliche Dokumente.|
|44430 |Verkaufsauftrag |Neue Einstellung in ExFlow Verkaufsauftrags-Import – Zuordnung von Verkaufsaufträgen.|
|44877 |Technisch |Erforderliche Ereignisse für benutzerdefinierte OCR-Import-Zuordnungsfelder.|
...
| ID | Bereich | Beschreibung |
| :----------- | :-------------- | :-------------- |
|44781 |Genehmigungsstatus |Dokumente bei Verwendung der Weiterverrechnung in Schwedisch prüfen – Aktionsmeldung.|
|45040 |Importjournal |MwSt.-Fehler bei NA-Rechnungen mit steuerpflichtigen und nicht steuerpflichtigen Positionen.|
|45483 |Genehmigungsstatus |Stapelaktualisierung des Buchungsdatums – Abgrenzungsbuchungsdatum nicht aktiviert – aktualisiert Abgrenzungszeitplan.|
|45599 |Importjournal |Artikelkostenzuweisung funktioniert nicht korrekt, wenn sie vor der Dokumentenprüfung durchgeführt wird.|
|45157 |Verkaufsauftrag |ExFlow Verkaufsimport – Verkaufsauftrag erstellen – Auftrag wird ohne Kundennummer erstellt – keine Verkaufspositionen werden erstellt.|
|45573 |Importjournal |ExFlow-Dateiimport – Import schlägt fehl, wenn PDFs ohne XML vorhanden sind.|
|45111 |Importjournal |Fehlermeldung: Ein Fehler ist aufgetreten und die Transaktion wurde gestoppt. Wenden Sie sich an Ihren Administrator oder Partner.|
|45361 |Technisch |Kommunikation mit Diensten – GetUserAgent – enthält ungültige Zeichen, die vom ISV hinzugefügt wurden.|
|41731 |Web |ExFlow Web – Zeilentyp ändern – mehrere Probleme.|
|46254 |Importjournal |ExFlow Einkaufskennzeichen und Sonstiges 1 & 2 – Sonstiges wird beim Erstellen von Zeilen nicht ausgeschlossen.|
