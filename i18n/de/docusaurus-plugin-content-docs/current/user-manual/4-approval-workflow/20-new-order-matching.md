...
![ExFlow Import Journal - Order No.](@site/static/img/FM-001.png)
...
![Order Matching Wizard - Search](@site/static/img/new-om-wizard-001.png)
...
![OM](@site/static/img/new-om-wizard-002.png)
...
![Order Matching Wizard - Search](@site/static/img/new-om-wizard-003.png)
...
![Order Matching Wizard – Complete the Wizard](@site/static/img/new-om-wizard-004.png)
...
![OM Setup](@site/static/img/order-matching-setup-001.png)
...
![Copy Purchase Order Header – Setup](@site/static/img/po-header-value-on-invoice-setup-001.png)

For US and CA localization Tax Liable and Tax Area can also be copied from the Purchase Order to Purchase Invoice.

![Copy Purchase Order Header – Setup CA - US](@site/static/img/po-header-value-on-invoice-setup-002-ca-us.png)
...
![ExFlow Receiving Line Types](@site/static/img/auto-receiving-line-types-001.png)
...
![Item No. Matching Priority](@site/static/img/exflow-setup-item-no-matching-prio-001.png)
...
![Item No. Matching Priority](@site/static/img/order-matching-prio-001.png)
...
![Matching Priority](@site/static/img/multiple-field-002.png)
...
![Matching Priority](@site/static/img/matching-ex-001.png)
...
![Matching Priority](@site/static/img/matching-ex-002.png)
...
![OM](@site/static/img/import-journal-filter-options-001.png)  
...
![OM](@site/static/img/import-journal-filter-options-002.png) 
...
![OM](@site/static/img/manual-om-001.png) 
