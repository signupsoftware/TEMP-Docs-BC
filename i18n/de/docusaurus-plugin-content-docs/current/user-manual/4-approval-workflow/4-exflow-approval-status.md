...
![ExFlow Genehmigungsstatus](@site/static/img/media/menu-001.png)
...
![ExFlow Genehmigungsstatus](@site/static/img/media/approval-status-003.png)
...
![ExFlow Genehmigungsstatus](@site/static/img/media/approval-status-004.png)
...
![ExFlow Setup - Eskalation](@site/static/img/media/exflow-setup-escalation-001.png)
...
![Genehmigungsstatus - Änderungen überprüfen](@site/static/img/media/image244.png)
...
![Genehmigungsstatus - Änderungen überprüfen](@site/static/img/media/image245.png)
...
![ExFlow Setup - Änderungen automatisch überprüfen](@site/static/img/media/exflow-setup-background-processing-001.png)
...
![ExFlow Änderungen überprüfen](@site/static/img/media/verify-changes-001.png)
...
![Genehmigungsprozess neu starten](@site/static/img/media/restat-from-marked-approver-001.png)
...
![Diskussionsfeld-Dialogfeld](@site/static/img/media/discussion-panel-dialog-001.png)
...
![Genehmigungsstatus](@site/static/img/media/approval-status-002.png)
...
![Stapelbuchung von Einkaufsdokumenten](@site/static/img/media/image247.png)
...
![Stapelbuchung von Einkaufsdokumenten](@site/static/img/media/image248.png)
...
![Meldung bei Stapelbuchung von Einkaufsdokumenten](@site/static/img/media/batch-create-post-message-001.png)
...
![Mehr auswählen](@site/static/img/media/image249.png)

Klicken Sie dann auf Post Batch, um mit dem Posten fortzufahren.

![Mehrere Dokumente auswählen und posten](@site/static/img/media/image250.png)
...
![ExFlow Genehmigungsstatus - Erinnerung senden](@site/static/img/media/image251.png)
...
![ExFlow Genehmigungsstatus - Erinnerung senden](@site/static/img/media/image252.png)

Folgende Nachricht wird dann angezeigt:

![ExFlow Genehmigungsstatus - Erinnerung senden](@site/static/img/media/image253.png)
...
![ExFlow Genehmigungsstatus - PDF-Viewer in neuem Tab öffnen](@site/static/img/media/image254.png)
...
![ExFlow Genehmigungsstatus - Einkaufsdokument erzwingen](@site/static/img/media/image255.png)
...
![ExFlow Genehmigungsstatus - Nach Genehmiger filtern](@site/static/img/media/image256.png)
...
![ExFlow Genehmigungsstatus - Dokumentzeilen](@site/static/img/media/image257.png)
...
![Route neu starten](@site/static/img/media/image258.png)
...
![ExFlow Genehmigungsstatus - Dok. Zeilen Genehmiger](@site/static/img/media/image259.png)
...
![Route neu starten](@site/static/img/media/image260.png)

### Genehmigungsfluss ändern
Zeile auswählen und gehe zu: ***Dokumentzeilen \--\> Zeile \--\> Genehmigung.***

![ExFlow Genehmigungsstatus - Dokumentzeilen](@site/static/img/media/image261.png)
...
![ExFlow Genehmigungsstatus](@site/static/img/media/image262.png)

Größe des FactBox zurücksetzen Klicke auf "Wiederherstellen".

![PDF-Vorschau](@site/static/img/media/image263.png)

"Verkleinern", "Vergrößern" und Zoom zurücksetzen

![PDF-Vorschau](@site/static/img/media/image264.png)

PDF-Seitennummer ändern Verwende "Aufnahmetasten".

![PDF-Vorschau](@site/static/img/media/image265.png)
...
![ExFlow Genehmigungsstatus - Eingehende Dokumentdateien](@site/static/img/media/image266.png)
...
![ExFlow Genehmigungsstatus - Diskussionspanel](@site/static/img/media/image267.png)
...
![ExFlow Genehmigungsstatus](@site/static/img/media/image268.png)
...
![ExFlow Genehmigungsstatus - Dok.-Zeilen-Genehmiger](@site/static/img/media/image269.png)
...
![ExFlow Setup - Hintergrundverarbeitung](@site/static/img/media/exflow-setup-background-processing-002.png)
...
![ExFlow Setup - Hintergrundverarbeitung - Überprüfen mit Job-Queue](@site/static/img/media/exflow-setup-background-processing-003.png)
...
![ExFlow Setup - Hintergrundverarbeitung - Überprüfen & Buchen mit Job-Queue](@site/static/img/media/exflow-setup-background-processing-004.png)
...
![ExFlow Setup - Hintergrundverarbeitung - Änderungen automatisch überprüfen](@site/static/img/media/exflow-setup-background-processing-005.png)
...
![ExFlow Setup - Hintergrundverarbeitung - Dokumente automatisch erstellen](@site/static/img/media/background-processing-automatically-create-001.png)
...
![ExFlow Setup - Hintergrundverarbeitung - Dokumente automatisch erstellen](@site/static/img/media/background-processing-automatically-create-002.png)
...
![ExFlow Setup - Dok.-Buchungsprüfungen - Rechnungsrundung](@site/static/img/media/exflow-setup-doc-posting-checks-001.png)
...
![Aktueller Vertreter](@site/static/img/media/approval-status-replacer-001.png)
